...
class OperationsHelper(BasePage):
    ...
    def enter_name(self, text):
        self.enter_text_into_field(
            TestSearchLocators.ids["LOCATOR_ENTER_NAME"], text, description="name form")

    def enter_email(self, text):
        self.enter_text_into_field(
            TestSearchLocators.ids["LOCATOR_ENTER_EMAIL"], text, description="email form")

    def enter_text(self, text):
        self.enter_text_into_field(
            TestSearchLocators.ids["LOCATOR_ENTER_TEXT"], text, description="content form")
    ...
    def Contact_click(self):
        self.click_button(TestSearchLocators.ids["LOCATOR_CONTACT_CLICK"], description="contact_click form")

    def click_contact_us(self):
        logging.info("click_contact_us")
        self.click_button(TestSearchLocators.ids["LOCATOR_CONTACT_US_CLICK"], description="us_click form")
